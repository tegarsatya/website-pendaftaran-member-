			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="judul_video" class="form-control form-control-lg" value="<?php echo set_value('judul_video') ?>" placeholder="judul video " required>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="video" class="form-control form-control-lg" value="<?php echo set_value('video') ?>" placeholder="Masukan Link Video" required>
					</div>
				</div>
