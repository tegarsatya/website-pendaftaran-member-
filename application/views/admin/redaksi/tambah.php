...
// Form
echo form_open_multipart('admin/redaksi/tambah');
?>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" name="nama_redaksi" class="form-control form-control-lg" value="<?php echo set_value('nama_redaksi') ?>" placeholder="Nama Redaksi" required>
					</div>
				</div>

				<div class="col-md-6">
					<div class="form-group form-group-lg">
						<label>Status redaksi</label>
