...
// Form
echo form_open_multipart('admin/struktur/edit/' .	$struktur->id_struktur);
?>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea name="keterangan" class="form-control" placeholder="keterangan" id="isi"><?php echo $struktur->keterangan ?></textarea>
					</div>
				</div>
			</div>
